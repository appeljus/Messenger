...
Packets die voor utility worden gebruikt, beginnen met hun naam (BROADCAST, NAME_IN_USE, etc) tussen blokhaken. Namen mogen geen [ of ] bevatten, dus kan er zo geen error in komen.
